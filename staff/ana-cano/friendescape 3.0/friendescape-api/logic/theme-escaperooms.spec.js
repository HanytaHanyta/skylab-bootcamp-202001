...
const themeEscapeRoom = require('./theme-escaperooms')


describe('themeEscapeRoom', () => {
    before(() =>
    ...
    it('should succeed on valid retrieve escaperoom by theme', async () => {
        const themeEscapeRooms = await themeEscapeRoom(query)

...
const difficultyEscaperoom = require('./difficulty-escaperooms')


describe('difficultyEscaperoom', () => {
    before(() =>
    ...
    it('should succeed on valid retrieve escaperoom by query', async () => {
        const difficultyEscaperooms = await difficultyEscaperoom(query)

        expect(difficultyEscaperooms).to.exist

 

        difficultyEscaperooms.forEach(element => {
